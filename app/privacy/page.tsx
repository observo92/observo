  ...
  return (
    <div className="max-w-3xl mx-auto px-5 py-10 flex-1 w-full">
      ...
      <div className="card p-6 mb-5">
        <h2 className="font-semibold font-display mb-2">The short version</h2>
      ...
      <div className="card p-6 mb-5">
        <h2 className="font-semibold font-display mb-2">What we collect</h2>
      ...
      <div className="card p-6 mb-5">
        <h2 className="font-semibold font-display mb-2">What we don&apos;t do</h2>
        <ul className="text-sm text-gray-400 space-y-2 list-disc pl-5">
      ...
      <div className="card p-6 mb-5">
        <h2 className="font-semibold font-display mb-2">Third-party services</h2>
        <p className="text-sm text-gray-400 leading-relaxed">
      ...
      <div className="card p-6">
        <h2 className="font-semibold font-display mb-2">Questions</h2>
        <p className="text-sm text-gray-400 leading-relaxed">
